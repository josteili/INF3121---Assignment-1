...
public class Game {
	...
	/**
	 * Print out the menu to the user, showing the possible commands.
	 */
	...
	/**
	 * Prompt the user to type in letters for guessing the secret word.
	 * Loops until the user guesses correctly, or chooses to exit or restart.
	 */
